#ifndef SMARTFARM_TURBIDITY_DRIVER_H
#define SMARTFARM_TURBIDITY_DRIVER_H
...
public:
    TurbidityDriver(Adafruit_ADS1115* ads, const ADS1115SensorConfig& config) : ads_(ads), config_(config) {}
