#ifndef SMARTFARM_GAS_SENSOR_DRIVER_H
#define SMARTFARM_GAS_SENSOR_DRIVER_H
...
public:
    GasSensorDriver(Adafruit_ADS1115* ads, const ADS1115SensorConfig& config) : ads_(ads), config_(config) {}
