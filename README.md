...
- Mode selector values exposed over MQTT/HA: `AUTO`, `MANUAL`, `SCHEDULE`, `SAFE` (`AUTO` rule automation is implemented; `SCHEDULE`/`SAFE` currently have no dedicated runtime handlers in `main.cpp`)
